...
<asp:Panel ID="pnlEventsModuleModerate" runat="server">
    <div class="dnnForm EventModerate">
        <div class="dnnFormItem">
            ...
            <asp:RadioButtonList ID="rbModerate" runat="server" RepeatDirection="Vertical" CssClass="dnnFormRadioButtons" ToolTip="Select Events to Moderate Events or Enrollment to Moderate Event Enrollment" AutoPostBack="True">
        ...
        <ul class="dnnActions dnnClear">
            ...
            <li><asp:LinkButton ID="cmdUpdateSelected" CssClass="dnnSecondaryAction" runat="server" resourcekey="cmdUpdateSelected" CausesValidation="False" /></li>
            <li><asp:LinkButton ID="cmdSelectApproveAll" CssClass="dnnSecondaryAction" runat="server" resourcekey="cmdSelectApproveAll" CausesValidation="False" /></li>
            <li><asp:LinkButton ID="cmdSelectDenyAll" CssClass="dnnSecondaryAction" runat="server" resourcekey="cmdSelectDenyAll" CausesValidation="False" /></li>
            <li><asp:LinkButton ID="cmdUnmarkAll" CssClass="dnnSecondaryAction" runat="server" resourcekey="cmdUnmarkAll" CausesValidation="False" /></li>
        </ul>
    </div>
</asp:Panel>
