...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td style="width:179px">
                [event:moderateurl]</td>
            <td>
                URL of the moderation page</td>
        </tr>
        <tr>
            <td style="width:179px">
                &nbsp;</td>
        ...
        <tr>
            <td style="width:179px">
                [event:repeaterheadertext]</td>
            <td>
                Localizable header text (TokenListRptHeader) - Header template only</td>
        </tr>
        <tr>
            <td style="width:179px">
                [event:repeaterzeroeventstext]</td>
            <td>
                Localizable text for text (TokenListRptHeaderZeroEvents) to displayed when there are no events to be listed - Header template only</td>
        </tr>
        <tr>
            <td style="width:179px; vertical-align:top">
                [event:repeatertooltip]</td>
            <td>
                Event tooltip when not using table layout - advanced users only.
                <br />
                E.g. <i>&lt;li [event:repeatertooltip]&gt;[event:title]&lt;/li&gt; </i>
                <br />
                Body template only.</td>
        </tr>
        <tr>
            <td style="width:179px">
                [event:repeaterfootertext]</td>
            <td>
                Localizable footer text (TokenListRptFooter) - Footer template only</td>
        </tr>
        <tr>
            <td style="width:179px">
                IFZEROEVENTS</td>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>IFHASIMAGE</td>
            <td>Includes the text specified within the token if the event has been assigned an 
                image.</td>
        ...
        <tr>
            <td>NOTPRIVATE</td>
            <td>Includes the text specified within the token if the event is not private (or you 
        ...
        <tr>
            <td>PRIVATE</td>
            <td>Includes the text specified within the token if the event is private and your 
                are not the owner/moderator.</td>
        ...
        <tr>
            ...
            <td>
                ...
                text specified within the token is included.</td>
            <td>
                [CUSTOMDETAILPAGE][event:titleurl][/CUSTOMDETAILPAGE]</td>
        </tr>
        <tr>
            <td>
                IFMULTIDAY</td>
            <td>
                If the event is longer than 1440 minutes, the text specified within the token is included.</td>
            <td>
                [IFMULTIDAY][event:durationdays] [event:durationdayslabel][/IFMULTIDAY]</td>
        </tr>
        <tr>
            <td>
                IFNOTMULTIDAY</td>
