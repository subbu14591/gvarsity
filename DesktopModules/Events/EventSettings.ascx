...
<div class="dnnForm EventSettings" id="EventSettings">
	...
	<div class="GeneralSettings dnnClear" id="GeneralSettings">
        <h2 class="dnnFormSectionHead" id="dnnPanel-AdminSettings"><a href="" class="dnnSectionExpanded"><%=LocalizeString("AdminSettings")%></a></h2>
        ...
        <h2 class="dnnFormSectionHead" id="dnnPanel-LookFeelSettings"><a href="" class=""><%=LocalizeString("LookFeelSettings")%></a></h2>
        <fieldset class="dnnClear">
            <div>
                <div class="dnnFormItem">
        ...
        <h2 class="dnnFormSectionHead" id="dnnPanel-TimeZoneSettings"><a href="" class=""><%=LocalizeString("TimeZoneSettings")%></a></h2>
        <fieldset class="dnnClear">
            <div>
                <div class="dnnFormItem">
    ...
    <div class="DisplaySettings dnnClear" id="DisplaySettings">
        <h2 class="dnnFormSectionHead" id="dnnPanel-DetailSettings"><a href="" class="dnnSectionExpanded"><%=LocalizeString("DetailSettings")%></a></h2>
        <fieldset class="dnnClear">
            <div>
                <div class="dnnFormItem">
        ...
        <h2 class="dnnFormSectionHead" id="dnnPanel-MonthSettings"><a href="" class=""><%=LocalizeString("MonthSettings")%></a></h2>
        <fieldset class="dnnClear">
            <div>
                <div class="dnnFormItem">
        ...
        <h2 class="dnnFormSectionHead" id="dnnPanel-WeekSettings"><a href="" class=""><%=LocalizeString("WeekSettings")%></a></h2>
        <fieldset class="dnnClear">
            <div>
                <div class="dnnFormItem">
        ...
        <h2 class="dnnFormSectionHead" id="dnnPanel-EventListSettings"><a href="" class=""><%=LocalizeString("EventListSettings")%></a></h2>
        <fieldset class="dnnClear">
            <div>
                <div class="dnnFormItem">
        ...
        <h2 class="dnnFormSectionHead" id="dnnPanel-CustomFields"><a href="" class=""><%=LocalizeString("CustomFields")%></a></h2>
        <fieldset class="dnnClear">
            <div>
                <div class="dnnFormItem">
        ...
        <h2 class="dnnFormSectionHead" id="dnnPanel-TooltipSettings"><a href="" class=""><%=LocalizeString("TooltipSettings")%></a></h2>
        <fieldset class="dnnClear">
            <div>
                <div class="dnnFormItem">
        ...
        <h2 class="dnnFormSectionHead" id="dnnPanel-ImageSettings"><a href="" class=""><%=LocalizeString("ImageSettings")%></a></h2>
        <fieldset class="dnnClear">
            <div>
                <div class="dnnFormItem">
    ...
    <div class="EmailandReminderSettings dnnClear" id="EmailandReminderSettings">
        ...
        <h2 class="dnnFormSectionHead" id="dnnPanel-NotificationSettings"><a href="" class=""><%=LocalizeString("NotificationSettings")%></a></h2>
        <fieldset class="dnnClear">
            <div>
                <div class="dnnFormItem">
    ...
    <div class="IntegrationSettings dnnClear" id="IntegrationSettings">
        ...
        <h2 class="dnnFormSectionHead" id="dnnPanel-vCalSettings"><a href="" class=""><%=LocalizeString("vCalSettings")%></a></h2>
        <fieldset class="dnnClear">
            <div>
                <div class="dnnFormItem">
        ...
        <h2 class="dnnFormSectionHead" id="dnnPanel-SocialSettings"><a href="" class=""><%=LocalizeString("SocialSettings")%></a></h2>
        <fieldset class="dnnClear">
            <div>
                <div class="dnnFormItem">
