...
;(function($) {
	...
	$.widget("ui.stars", {
      ...
      this.$stars = this.$rboxs.map(function(i) {
        ...
        var $s = $("&lt;div/&gt;").addClass(o.starClass + "-" + i + " " + o.starClass);
      ...
      function fillTo(index, hover) {
        if(index != -1) {
          ...
          self.$stars.eq(index).prevAll("." + o.starClass + "-" + i + " " + o.starClass).andSelf().removeClass(remClass).addClass(addClass);
          self.$stars.eq(index).nextAll("." + o.starClass + "-" + i + " " + o.starClass).removeClass([o.starHoverClass, o.starOnClass].join(' '));
