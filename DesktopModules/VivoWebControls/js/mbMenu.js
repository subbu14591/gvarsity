    ...
    buildMbMenu: function(op,m,type,e){
      ...
      $(this.voices).each(function(i){
        ...
        if (op.options.hasImages && !isText){
          ...
          var imgPath=$(voice).attr("img")?$(voice).attr("img"):"";
        ...
        if(isSeparator)
          line="<div class='separator' style='width:100%; display:inline-block'><img src='"+op.options.iconPath+"' width='1' height='1'></div>";
        if(isText)
