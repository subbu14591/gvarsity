...
Version     : 2.6
Released    : May 2012
Style       : Charcool FullWidth Breadcrumb
DNN Version : 6
...
<div class="headerDiv clearfix">
	<div class="header clearfix">
		...
		<div class="pageName"><span><%= PortalSettings.ActiveTab.TabName %></span></div>
	</div>
</div>
...
<div class="pageContent clearfix">
	<div class="pageWidth clearfix">
		<div class="breadcrumbdiv">
			<div class="left"><a href="/" class="breadcrumb-pretext">Home</a></div>
			<div class="left">&nbsp;/
				<dnn:BREADCRUMB runat="server" id="dnnBREADCRUMB" Separator="&nbsp;/&nbsp;" RootLevel="0" CssClass="breadcrumb" />
			</div>
		</div>
